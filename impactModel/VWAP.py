class VWAP(object):
    ...
    def __init__( self, data, startTS, endTS ):
        ...
        if ( data == None ) or ( data.getPrice == None ) or ( data.getTimestamp == None ) or ( data.getPrice == None ) or ( data.getN == None ):
            raise Exception( "Your data object must implement getTimestamp(i), getSize(i), getPrice(i), and getN() methods" ) 
