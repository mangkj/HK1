...
class FileManager(object):
    '''
    Class to manage TAQ files for ATQS 2018
    '''
    def __init__(
        self, 
    ...
    def getQuoteDates(self, startDateString, endDateString ):
        return self.__getDates__( self._baseDir + "quotes", startDateString, endDateString )
    ...
    def __getDates__(
        ...
        goodDirs = list(
            filter(
                lambda dirName: self.__goodDate__( startDate, endDate, dirName ),
                os.listdir( dir )
            )
        )
        return goodDirs
